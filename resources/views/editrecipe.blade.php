...
<!-- 內文開始 -->
  <div class="container">
    ...
    <!-- input group -->
    <form method="post" action="{{ route('recipe.update', $recipecases->recpieId ) }}">
      @csrf
      @method('PATCH')
      ...
      <div class="row">
        <div class="col-lg-8 mx-auto">
          <div class="form-group">
            ...
            <textarea class="form-control" id="exampleFormControlTextarea1" rows="1" name="recipeName" value="{{ $recipecases->recipeName }}">{{ $recipecases->recipeName }}</textarea>
      ...
      <div class="row">
        <div class="col-lg-8 mx-auto">
          <div class="form-group">
            ...
            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="ingredients" value="{{ $recipecases->ingredients }}">{{ $recipecases->ingredients }}</textarea>
      ...
      <div class="row">
        <div class="col-lg-8 mx-auto">
          <div class="form-group">
            ...
            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="step" value="{{ $recipecases->step }}">{{ $recipecases->step }}</textarea>
          </div>
        </div>
        <div class="col-lg-4 mx-auto">
        </div>
